...
//   const { setMessages, languageModel } = useChatContext();
...
//         role: 'user',
//         content: [{ type: 'text', text: `Based on the specification: "${specification}", let's explore this idea: "${idea}"` }],
//       };
...
//         role: 'assistant',
//         content: [{ type: 'text', text: `Here's an initial analysis for the idea "${idea}" based on your specification:\n\n1. Concept overview\n2. Key features\n3. Potential challenges\n4. Next steps` }],
//       };
...
//   const handleExploreIdea = (idea: string) => {
//     router.push('/chat');
//   };
...
//             <CardFooter>
//               <Button variant="outline" onClick={() => handleExploreIdea(idea)}>
//                 Explore This Idea
//               </Button>
//             </CardFooter>
//           </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {ideas.map((idea, index) => (
          <Card key={index}>
            ...
            <CardContent>{idea}</CardContent>
            <CardFooter>
              <Link href={`/chat?initialMessage=${encodeURIComponent(specification)}&idea=${encodeURIComponent(idea)}`} passHref>
